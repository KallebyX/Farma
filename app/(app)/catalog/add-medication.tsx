          ...
          >
            ...
            <form onSubmit={onSubmit}>
              <div className="px-5 py-5 space-y-4 max-h-[70vh] overflow-y-auto">
                ...
                <Field label="Nome comercial *" htmlFor="brandName" error={errors.brandName}>
                  <input
                    id="brandName"
                    name="brandName"
                    required
                ...
                <Field label="Princípio ativo *" htmlFor="activeIngredient" error={errors.activeIngredient}>
                  <input
                    id="activeIngredient"
                ...
                <div className="grid grid-cols-2 gap-3">
                  <Field label="Dosagem *" htmlFor="dosage" error={errors.dosage}>
                    <input
                      id="dosage"
                      name="dosage"
                      required
                  ...
                  <Field label="Forma farmacêutica *" htmlFor="form" error={errors.form}>
                    <select
                      id="form"
                      name="form"
                      required
                ...
                <Field label="Fabricante (opcional)" htmlFor="manufacturerName" error={errors.manufacturerName}>
                  <input
                    id="manufacturerName"
                ...
                <Field label="Classe terapêutica (opcional)" htmlFor="therapeuticClass" error={errors.therapeuticClass}>
                  <input
                    id="therapeuticClass"
